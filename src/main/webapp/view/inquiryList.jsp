...
<div class="inquiry-wrap">
  ...
  <h2 class="cstitle">고객센터</h2>
  <div class="write-btn">
  	<a href="#" onclick="return goWrite('<%=userId%>')">글쓰기</a>  
  </div>
    ...
    <tbody>
      <% if (list != null && !list.isEmpty()) {
        ...
        <tr>
          <td><%= dto.getId() %></td>
          <td class="title">
			  <a class="title-link" href="<%=request.getContextPath()%>/view/inquiryView.jsp?id=<%= dto.getId() %>">
              <%= dto.getTitle() %>
            </a>
          </td>
          <td><%= dto.getWriter() %></td>
          <td><%= new java.text.SimpleDateFormat("yyyy-MM-dd").format(dto.getCreatedAt()) %></td>
        </tr>
      <% } } else { %>
        <tr><td colspan="4">등록된 문의글이 없습니다.</td></tr>
      <% } %>
    </tbody>
  </table>
...
<footer>
  ...
  <div class="footerdetail">
    ...
    <div class="footerwrite">
      ...
      <span>사업자등록번호 312-82-06581 / 통신판매업신고번호 2022-충남아산-0280호</span><br />
